...
public class WordCounterTestsConcurrent : IDisposable
{
    private readonly string _directory;
    public WordCounterTestsConcurrent()
    {
    ...
    {
        var testDirectory = Directory.CreateDirectory(Path.Combine(Directory.GetCurrentDirectory(), "TestDirectoryConcurrent"));
    ...
    {
        // Arrange
        var wordCounter = new WordCounter5StreamingParallelV2(_directory);
    ...
    public void GetExcludedWordCount_ShouldReturnCorrectExcludedWordCount()
    {
        // Arrange
        var wordCounter = new WordCounter5StreamingParallelV2(_directory);
        var words = new ConcurrentDictionary<string, int>(new Dictionary<string, int> { { "hello", 2 }, { "world", 1 }, { "github", 1 } });
